...
<!--          </div>-->
<!--          <p class="text-base text-gray-700 my-3">{{ post.description}}</p>-->
<!--          <nuxt-link :to="post.slug" class="text-base font-semibold text-gray-700 my-3 hover:underline">Read more ></nuxt-link>-->
<!--        </div>-->
<!--      </div>-->
<!--    </div>-->
